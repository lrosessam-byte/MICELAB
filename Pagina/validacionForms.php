...
if (isset($_SESSION['count'])) {
 ...
 $newform1="CREATE TABLE `$Nombretabla` (ID INT(10) UNSIGNED AUTO_INCREMENT PRIMARY KEY NOT NULL  , IDC VARCHAR(30) NULL , Compuesto VARCHAR(30) NULL , Funcion VARCHAR(30) NULL , Porcentaje FLOAT(10) NULL, Costo FLOAT(10) NULL)";
