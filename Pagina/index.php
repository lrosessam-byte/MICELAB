...
function Actualizar ($IDA, $NombreA,$ProveedorA){

header("Location: " . $_SERVER['PHP_SELF']);
   include ("Conexioninv.php");
$sqlIA = "UPDATE Inventario SET ID=$IDA, Nombre='$NombreA', Proveedor='$ProveedorA' WHERE ID=$IDA";
Echo($IDA);

Echo($NombreA);
Echo($ProveedorA);
$resultadoA = $conexionI->query($sqlIA);
if(!$resultadoA){
